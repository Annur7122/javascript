function Change(){
    ...
    if(val.value === 'usd'){
        ...
        document.getElementById("tenge").innerHTML = (parseFloat(inp.value) * 456.41).toFixed(2) ;
        ...
        document.getElementById("tenge").innerHTML = (parseFloat(inp.value) * 488.24).toFixed(2);
